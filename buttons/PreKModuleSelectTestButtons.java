...
/**
 * This class is used to describe the set of Test module buttons available to a PreK-K student.
 ...
 * @author Kenneth Chin
 */
public class PreKModuleSelectTestButtons implements EnumerableButtonFactory{
	
	//The file path prefix for all button images starting from the program's root directory.
	private static final String   PREK_IMAGE_PATH      = "\\images\\moduleSelect\\preK-K";
	 ...
	 */
	public PreKModuleSelectTestButtons(int lastActiveButton) throws IOException{
		if(lastActiveButton > numberOfButtons || lastActiveButton < 0)
			throw new IndexOutOfBoundsException("PreKModuleSelectTestButtons(lastActiveButton): The parameter"
	...
	private void initButtons() throws IOException{
		...
		for(int i=0; i<buttons.length; i++){
			...
			if(i < lastActiveButton){
				imagePath = PREK_IMAGE_PATH + ACTIVE_BUTTON_PATH   + "\\" + buttons[i].getFileName();
				isClickable = true;
			}
			else{
				imagePath = PREK_IMAGE_PATH + DISABLED_BUTTON_PATH + "\\" + buttons[i].getFileName();
				isClickable = false;
			}
	...
	/**
	 * This enum describes the individual buttons of PreKModuleSelectTestButtons. Each button
	...
	public enum Button implements ModuleSelectButtonInterface{
		...
		/**
		 * The Counting Prek-K Test module button.
		 */
		...
		/**
		 *  The Matching Prek-K Test module button.
		 */
		...
		/**
		 * The Sequences Prek-K Test module button.
		 */
		...
		/**
		 * The Comparison Prek-K Test module button.
		 */
		...
		/**
		 * The Fractions Prek-K Test module button.
		 */
		...
		/**
		 * The Coins Prek-K Test module button.
		 */
		...
		/**
		 * The Arithmetic Prek-K Test module button.
		 */
