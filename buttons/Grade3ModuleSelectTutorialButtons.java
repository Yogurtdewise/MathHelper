 ...
 * @author Kenneth Chin
 */
public class Grade3ModuleSelectTutorialButtons implements EnumerableButtonFactory{
	 ...
	 */
	public Grade3ModuleSelectTutorialButtons() throws IOException{
		initButtons();
	}
	...
	/**
	 * This enum describes the individual buttons of Grade3ModuleSelectTutorialButtons. Each button
	...
	public enum Button implements ModuleSelectButtonInterface{
		...
		/**
		 * The Comparison Grade3-4 Tutorial module button.
		 */
		...
		/**
		 *  The Expansion Grade3-4 Tutorial module button.
		 */
		...
		/**
		 * The Fractions Grade3-4 Tutorial module button.
		 */
		...
		/**
		 * The Decimals Grade3-4 Tutorial module button.
		 */
		...
		/**
		 * The Number Classes Grade3-4 Tutorial module button.
		 */
		...
		/**
		 * The Word Problems Grade3-4 Tutorial module button.
		 */
		...
		/**
		 * The Properties Grade3-4 Tutorial module button.
		 */
		...
		/**
		 * The Relations Grade3-4 Tutorial module button.
		 */
		...
		/**
		 * The Arithmetic Grade3-4 Tutorial module button.
		 */
		...
		/**
		 * The Estimate Grade3-4 Tutorial module button.
		 */
