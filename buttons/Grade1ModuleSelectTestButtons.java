 ...
 * @author Kenneth Chin
 */
public class Grade1ModuleSelectTestButtons implements EnumerableButtonFactory{
	
	//The file path prefix for all button images starting from the program's root directory.
	private static final String   GRADE1_IMAGE_PATH    = "\\images\\moduleSelect\\grade1-2";
	 ...
	 */
	public Grade1ModuleSelectTestButtons(int lastActiveButton) throws IOException{
		if(lastActiveButton > numberOfButtons || lastActiveButton < 0)
			throw new IndexOutOfBoundsException("Grade1ModuleSelectTestButtons(lastActiveButton): The parameter"
	...
	private void initButtons() throws IOException{
		...
		for(int i=0; i<buttons.length; i++){
			...
			if(i < lastActiveButton){
				imagePath = GRADE1_IMAGE_PATH + ACTIVE_BUTTON_PATH   + "\\" + buttons[i].getFileName();
				isClickable = true;
			}
			else{
				imagePath = GRADE1_IMAGE_PATH + DISABLED_BUTTON_PATH + "\\" + buttons[i].getFileName();
				isClickable = false;
			}
	...
	/**
	 * This enum describes the individual buttons of Grade1ModuleSelectTestButtons. Each button
	...
	public enum Button implements ModuleSelectButtonInterface{
		...
		/**
		 * The Expansion Grade1-2 Test module button.
		 */
		...
		/**
		 *  The Measure Grade1-2 Test module button.
		 */
		...
		/**
		 * The Fractions Grade1-2 Test module button.
		 */
		...
		/**
		 * The Comparison Grade1-2 Test module button.
		 */
		...
		/**
		 * The Money Grade1-2 Test module button.
		 */
		...
		/**
		 * The Word Problems Grade1-2 Test module button.
		 */
		...
		/**
		 * The Arithmetic Grade1-2 Test module button.
		 */
		...
		/**
		 * The Estimation Grade1-2 Test module button.
		 */
		...
		/**
		 * The Final Grade1-2 Test module button.
		 */
