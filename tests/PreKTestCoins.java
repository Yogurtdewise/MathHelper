 ...
 * @author Kenneth Chin
 */
public class PreKTestCoins implements TestableObserver, Questionable{
	...
	/**
	 * Creates a PreKTestCoins object, without displaying anything. Used specifically for
	 ...
	 */
	public PreKTestCoins(GUIManager manager, boolean isPractice, DifficultyLevel difficulty,
